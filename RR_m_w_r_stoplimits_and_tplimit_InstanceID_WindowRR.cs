...
{
    public class RRLongTimeWinStopLimitTPlimitGAPWindowRR : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "RRLongTimeWinStopLimitTPlimitGAPWindowRR";
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (Close[0] < Open[0])
			{
				...
				if (ask >= entryPrice)
				{
					Print($"[{Time[0]}] [{EntrySignalName}] Gap above entry -> skipping stop placement");
					return;
				}
