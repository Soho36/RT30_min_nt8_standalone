    ...
    public class RRmwrstoplimitsandtplimitAlert : Strategy
    {
        ...
        protected override void OnConnectionStatusUpdate(ConnectionStatusEventArgs connectionStatusUpdate)
        {
            ...
            if (connectionStatusUpdate.PriceStatus == ConnectionStatus.ConnectionLost)
            {
                ...
                {
                    SendConnectionLostEmail("PRICE", connectionStatusUpdate);
            ...
            if (connectionStatusUpdate.Status == ConnectionStatus.ConnectionLost)
            {
                ...
                {
                    SendConnectionLostEmail("ORDER", connectionStatusUpdate);
        ...
        private void SendConnectionLostEmail(string connectionType, ConnectionStatusEventArgs connectionStatusUpdate)
        {
            ...
            if (ConnectionEmailCooldownMinutes > 0 && lastEmailTime != Core.Globals.MinDate &&
